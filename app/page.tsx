  ...
  return (
    <>
      <main className="min-h-screen">
        <section className="mx-auto flex w-full max-w-7xl flex-col px-12 py-20 sm:px-6 lg:px-14 lg:py-32">
          <div className="pb-12">
          ...
          <section className="py-20">
            <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between py-20 sm:items-start lg:py-32">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground space-y-6 text-sm leading-relaxed text-pretty">
                    ...
                    <p>
                      ...
                      corporation. My section focus these days is building
          ...
          <section className="py-20">
            <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col items-center justify-center sm:items-start sm:px-6 lg:px-14">
              <div className="pb-8">
          ...
          <section className="py-20">
            <div className="mx-auto flex w-full max-w-7xl flex-col items-center sm:px-6 lg:px-14">
              ...
              <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2 lg:gap-10">
                <div className="flex p-4 leading-relaxed text-pretty">
                  <Card className="border-l-sidebar-accent h-full w-96 cursor-pointer border transition-all duration-600 hover:-translate-y-2 hover:scale-[1.02] hover:shadow-xl">
                    <CardHeader>
                ...
                <div className="leading-relaxed text-pretty">
                  <Card className="border-r-sidebar-accent h-full w-96 cursor-pointer border transition-all duration-600 hover:-translate-y-2 hover:scale-[1.02] hover:shadow-xl">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Frontend development with React, Next.js & modern UI/UX
                        best practices
                      </CardDescription>
                    </CardHeader>
                  </Card>
          ...
          <section className="py-2">
            <div className="max-w-7x mx-auto w-full sm:items-start sm:px-6 lg:px-14">
          ...
          <section className="py-20">
            <div className="max-w-7x mx-auto w-full sm:items-start sm:px-6 lg:px-14">
              <div className="flex items-center justify-center">
                <Card className="ring-accent/30 w-full shadow-lg">
                  <CardHeader>
